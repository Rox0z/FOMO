...
async function seed() {
  ...
  const eventSeeds = [
    ...
    { vendorId: approvedVendors[0].id, name: 'Rock in Winter 2026', description: 'O maior festival indoor de rock.', location: 'MEO Arena, Lisboa', date: new Date('2026-11-15T21:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[0].id, name: 'Pop Fest Summer', description: 'Os maiores artistas da rádio ao vivo.', location: 'Estádio Cidade de Coimbra', date: new Date('2026-07-20T18:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[0].id, name: 'Tributo Histórico: Queen & Pink Floyd', description: 'Duas bandas de tributo lendárias.', location: 'Coliseu do Porto', date: new Date('2026-10-05T21:30:00Z'), status: 'approved' },
    { vendorId: approvedVendors[0].id, name: 'Indie Rock Sessions', description: 'Bandas independentes emergentes.', location: 'Hard Club, Porto', date: new Date('2026-09-12T22:00:00Z'), status: 'approved' },

    // Sons Urbanos (Hip-Hop / R&B)
    { vendorId: approvedVendors[1].id, name: 'Hip-Hop National Summit', description: 'Reunião dos maiores nomes do rap português.', location: 'Pavilhão Rosa Mota, Porto', date: new Date('2026-08-25T20:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[1].id, name: 'Trap & Drill Night', description: 'Subgéneros urbanos com graves pesados.', location: 'Lisboa Ao Vivo (LAV)', date: new Date('2026-06-18T23:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[1].id, name: 'R&B Classics & Soul Vibes', description: 'Uma noite dedicada às vozes melódicas.', location: 'Capitólio, Lisboa', date: new Date('2026-09-30T21:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[1].id, name: 'Cypher Live Portugal', description: 'Batalhas de improviso e breakdance.', location: 'Musicbox, Lisboa', date: new Date('2026-07-08T22:30:00Z'), status: 'approved' },

    // Sunset Concept Events (Eletrónica / Premium)
    { vendorId: approvedVendors[2].id, name: 'Deep House Rooftop Session', description: 'Música eletrónica com vista de 360º sobre a cidade.', location: 'Vip Grand Rooftop, Lisboa', date: new Date('2026-06-05T17:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[2].id, name: 'Techno Beach Opening 2026', description: 'Abertura oficial da época de praia com DJs internacionais.', location: 'Praia da Comporta', date: new Date('2026-06-28T15:00:00Z'), status: 'approved' },
    { vendorId: approvedVendors[2].id, name: 'Afro House Sunset', description: 'Ritmos quentes e percussivos ao final do dia.', location: 'NoSoloAgua, Vilamoura', date: new Date('2026-08-02T16:30:00Z'), status: 'approved' },
    { vendorId: approvedVendors[2].id, name: 'Premium Electronic Gala', description: 'Evento exclusivo com dress code elegante.', location: 'Pousada de Évora', date: new Date('2026-09-19T19:00:00Z'), status: 'approved' },
  ];
  ...
  const ticketPrice = 25; // Preço fixo simulado
